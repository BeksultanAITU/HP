...
Этот проект включает в себя четыре задания, которые демонстрируют основные принципы работы с динамической памятью в C++, а также использование OpenMP для параллельных вычислений.

## Файлы проекта:
1. **task1.cpp, task2.cpp, task3.cpp, task4.cpp** — исходный код для каждого из заданий. В каждом файле код программы с подробными комментариями, объясняющими логику работы.
2. **task1.jpg, task2.jpg, task3.jpg, task4.jpg** — изображения, которые показывают, как программа запустилась и какие результаты были получены в процессе выполнения.
3. **schema1.png, schema2.png, schema3.png, schema4.png** — блок-схемы для каждого из заданий.
